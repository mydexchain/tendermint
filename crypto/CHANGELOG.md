...
- Remove `cmd` and `keys/tx` packages altogether: move it to the Chain-SDK
...
- `github.com/mydexchain/go-keys -> github.com/mydexchain/go-crypto/keys` - command and lib for generating and managing encrypted keys
