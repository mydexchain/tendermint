...
const (
	...
	// https://github.com/mydexchain/tendermint/pull/3438
...
// dbStore wraps a db (github.com/mydexchain/tm-db)
type dbStore struct {
	db dbm.DB
}
...
// encoding not preserving ordering: https://github.com/mydexchain/tendermint/issues/4567
