...
import (
	...
	tmcon "github.com/mydexchain/tendermint/consensus"
	cstypes "github.com/mydexchain/tendermint/consensus/types"
	"github.com/mydexchain/tendermint/crypto"
	tmevents "github.com/mydexchain/tendermint/libs/events"
	"github.com/mydexchain/tendermint/libs/fail"
...
func (cs *State) handleMsg(mi msgInfo) {
	...
	case *tmcon.VoteMessage:
		...
		// a typical peer.
		// https://github.com/mydexchain/tendermint/issues/1281
		// }
...
func (cs *State) tryAddVote(vote *types.Vote, peerID p2p.ID) (bool, error) {
	...
	if err != nil {
		...
		if voteErr, ok := err.(*types.ErrVoteConflictingVotes); ok {
			...
			// 		(https://github.com/mydexchain/tendermint/issues/3839).
