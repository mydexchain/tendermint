...
import (
	...
	bcv0 "github.com/mydexchain/tendermint/blockchain/v0"
	bcv1 "github.com/mydexchain/tendermint/blockchain/v1"
	bcv2 "github.com/mydexchain/tendermint/blockchain/v2"
	cfg "github.com/mydexchain/tendermint/config"
	"github.com/mydexchain/tendermint/consensus"
	...
	tmpubsub "github.com/mydexchain/tendermint/libs/pubsub"
	...
	"github.com/mydexchain/tendermint/p2p/pex"
	"github.com/mydexchain/tendermint/privval"
	"github.com/mydexchain/tendermint/proxy"
	rpccore "github.com/mydexchain/tendermint/rpc/core"
	grpccore "github.com/mydexchain/tendermint/rpc/grpc"
	...
	blockidxkv "github.com/mydexchain/tendermint/state/indexer/block/kv"
	blockidxnull "github.com/mydexchain/tendermint/state/indexer/block/null"
	"github.com/mydexchain/tendermint/state/txindex"
	"github.com/mydexchain/tendermint/state/txindex/kv"
	"github.com/mydexchain/tendermint/state/txindex/null"
	"github.com/mydexchain/tendermint/statesync"
	"github.com/mydexchain/tendermint/store"
	cs "github.com/mydexchain/tendermint/test/maverick/consensus"
	"github.com/mydexchain/tendermint/types"
	tmtime "github.com/mydexchain/tendermint/types/time"
	"github.com/mydexchain/tendermint/version"
)
...
// See: https://github.com/mydexchain/tendermint/issues/4595
...
func createPEXReactorAndAddToSwitch(addrBook pex.AddrBook, config *cfg.Config,
	...
	pexReactor := pex.NewReactor(addrBook,
		&pex.ReactorConfig{
			...
			// https://github.com/mydexchain/tendermint/issues/3523
...
func NewNode(config *cfg.Config,
	...
	// https://github.com/mydexchain/tendermint/issues/4644
...
func (n *Node) startRPC() ([]net.Listener, error) {
	...
	// See https://github.com/mydexchain/tendermint/issues/3435
