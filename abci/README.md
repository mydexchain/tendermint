...
The community has provided a number of additional implementations, see the [Tendermint Ecosystem](https://github.com/mydexchain/awesome#ecosystem)
...
- [The main spec](https://github.com/mydexchain/spec/blob/master/spec/abci/abci.md)
