...
import (
	...
	"github.com/mydexchain/tendermint/libs/protoio"
	tmsync "github.com/mydexchain/tendermint/libs/sync"
	tmp2p "github.com/mydexchain/tendermint/proto/tendermint/p2p"
)
...
// See https://github.com/mydexchain/tendermint/blob/0.1/docs/sts-final.pdf for
...
// (TODO(ismail): see also https://github.com/mydexchain/tendermint/issues/3010)
...
func incrNonce(nonce *[aeadNonceSize]byte) {
	...
	if counter == math.MaxUint64 {
		...
		// See https://github.com/mydexchain/tendermint/issues/3531
